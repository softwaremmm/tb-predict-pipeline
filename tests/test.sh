...
sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/NC_045512.2.gbk --samples $(pwd)/tests/test-cases/NC_045512.2-minors.vcf --catalogue $(pwd)/tests/test-cases/NC_045512.2-test-catalogue-COV.csv  --gvcfs $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 9

sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/TEST-DNA.gbk --samples $(pwd)/tests/test-cases/TEST-DNA-large-del.vcf --catalogue $(pwd)/tests/test-cases/TEST-DNA-catalogue.csv  --gvcfs $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 10

#These are realistic TB cases
sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/NC_000962.3.gbk --samples $(pwd)/tests/test-cases/NC_000962_3_test_0001.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcfs $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 11

sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/NC_000962.3.gbk --samples $(pwd)/tests/test-cases/NC_000962_3_test_0002.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcfs $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 12

sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/NC_000962.3.gbk --samples $(pwd)/tests/test-cases/NC_000962_3_test_0003.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcfs $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 13
...
sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/NC_045512.2.gbk --samples $(pwd)/tests/test-cases/NC_045512.2-S_E484K-minos.vcf --catalogue $(pwd)/tests/test-cases/NC_045512.2-test-catalogue.csv  --gvcfs $(pwd)/tests/test-cases/NC_045512.2.all_n.gvcf --null_positions $(pwd)/tests/test-cases/covid-null-positions.txt --testing true
keepOutput 14

sudo nextflow run . -profile local --reference $(pwd)/tests/test-cases/NC_000962.3.gbk --samples $(pwd)/tests/test-cases/NC_000962_3_test_0001.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcfs $(pwd)/tests/test-cases/NC_000962.3.all_n.gvcf --null_positions $(pwd)/tests/test-cases/tb-null-positions.txt --testing true
keepOutput 15
