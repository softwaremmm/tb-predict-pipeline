...
gnomonicus_version=$(cat main.nf | grep -E "container\ " | grep "gnomonicus" | cut -d ":" -f 2 | tr -d \")
...
sudo nextflow run . -profile local --genbank_reference_dir $(pwd)/tests/test-cases/ --species TEST --sample $(pwd)/tests/test-cases/TEST-DNA-large-del.vcf --catalogue $(pwd)/tests/test-cases/TEST-DNA-catalogue.csv  --gvcf $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 10

#These are realistic TB cases
sudo nextflow run . -profile local --genbank_reference_dir $(pwd)/tests/test-cases/  --sample $(pwd)/tests/test-cases/NC_000962_3_test_0001.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcf $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 11

sudo nextflow run . -profile local --genbank_reference_dir $(pwd)/tests/test-cases/  --sample $(pwd)/tests/test-cases/NC_000962_3_test_0002.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcf $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 12

sudo nextflow run . -profile local --genbank_reference_dir $(pwd)/tests/test-cases/  --sample $(pwd)/tests/test-cases/NC_000962_3_test_0003.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcf $(pwd)/tests/test-cases/empty.gvcf --null_positions $(pwd)/tests/test-cases/no-null-positions.txt --testing true
keepOutput 13
...
sudo nextflow run . -profile local --genbank_reference_dir $(pwd)/tests/test-cases/  --sample $(pwd)/tests/test-cases/NC_000962_3_test_0001.vcf --catalogue $(pwd)/tests/test-cases/NC_000962_3_catalogue_1.csv  --gvcf $(pwd)/tests/test-cases/NC_000962.3.all_n.gvcf --null_positions $(pwd)/tests/test-cases/tb-null-positions.txt --testing true
keepOutput 15
